        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl font-bold mb-8 text-foreground">
              Por Que Você Paga <span className="text-luxury-gold">Centenas de Milhares</span> a Mais Sem Saber
            </h2>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-4 mb-8">
                  {[
                    "Acesso aos dados reais de vendas que nunca aparecem nos portais",
                    "Conhece cada prédio, cada vendedor, cada segredo do mercado local",
              ...
              {[
                {
                  ...
                  features: [
                    ...
                    "Inspeção detalhada de Marcus Godoy",
                ...
                },
                {
                  ...
                  features: [
                    ...
                    "Coordenação até entrega das chaves"
                  ],
                ...
                },
                {
                  ...
                  features: [
                    "Metodologia completa em 5 fases",
                ...
                <Card key={index} className={`relative border-0 ${plan.popular ? 'bg-white shadow-gold scale-105' : 'bg-white/5 border-white/10'}`}>
                  {plan.popular && (
