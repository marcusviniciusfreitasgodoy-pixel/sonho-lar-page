        ...
        <div className="relative z-10 container mx-auto px-6 text-center text-white">
          <div className="animate-fade-in">
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
                O Segredo dos Compradores Inteligentes
              <span className="text-luxury-gold"> O Imóvel Que Você Quer e Pelo Preço Justo</span>
            </h1>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-card border border-border rounded-2xl p-8 md:p-12 shadow-luxury">
              ...
              <p className="text-lg md:text-xl text-foreground mb-8 leading-relaxed">
                ...
                Podem até dizer que estão lutando por você, mas o objetivo é vender pelo maior preço possível. <strong>Simples Assim!
              </p> 
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-luxury-text-muted max-w-3xl mx-auto">
                Existe apenas uma maneira de não ser enganado nessa negociação.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <p className="text-lg text-luxury-navy mb-6 leading-relaxed">
                  ...
                  dinheiro, não quando gastar mais. Marcus Godoy criou o primeiro serviço de Personal Shopper 
                  Imobiliário da Barra da Tijuca.
                </p>
                
                <div className="space-y-4 mb-8">
                  {["Acesso aos dados reais de vendas que nunca aparecem nos portais", "Conhece cada prédio, cada vendedor, cada segredo do mercado local", "Representação exclusiva do comprador, sem conflito de interesses"].map((item, index) => <div key={index} className="flex items-start space-x-3">
            ...
            <div className="bg-white rounded-2xl p-8 md:p-12 shadow-luxury">
              <div className="prose prose-lg max-w-none text-luxury-navy">
                ...
                <p className="text-lg leading-relaxed mb-6">
                  ...
                  Cada um empurrava o que tinha na carteira. Meu amigo estava exausto, confuso e pronto para pagar 
